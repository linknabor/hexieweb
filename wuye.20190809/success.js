avalon.ready(function() {
    ...
    function showContent(){
    	...
    	if(o.userPayType=="0"){	//新用户手册支付
    		...
    		content = "您将获得由合协社区赠送的价值9.8元黑龙江五常稻花香大米试吃装（1斤装）一包及“为颠覆传统而生”的贝思客蛋糕35元现金券一张。具体活动规则及赠品信息详见“社区公告”。";
		
    	}else if (o.userPayType=="2") {	//老用户非首次支付
			
    		content = "您将获得由合协社区赠送的 “为颠覆传统而生”的贝思客蛋糕35元现金券一张。具体活动规则及赠品信息详见“社区公告”。";
